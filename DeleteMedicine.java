  ...
  l9.setBounds(470,180,200,25);
   ...
   l11.setBounds(470,260,180,25);
       ...
       l12.setBounds(470,300,180,25);
        ...
        b0 = new JButton("Open",new ImageIcon("E:\\Medical Shop Management\\src\\images\\open.png"));
        b0.setBounds(150,330,110,35);b0.setToolTipText("click to open medicine details");
		jf.add(b0);b0.addActionListener(this);

		b1 = new JButton("Delete",new ImageIcon("E:\\Medical Shop Management\\src\\images\\delete.png"));
    	...
    	b3 = new JButton("All",new ImageIcon("E:\\Medical Shop Management\\src\\images\\all.png"));//if button is press then record display repeat
