...
class About extends JFrame
{
	...
	About()
	{
		...
		l3 = new JLabel("Mr.Shraddhesh Prashant Kulkarni.");
		l3.setFont(new Font("Times New Roman",Font.BOLD,18));
		l3.setBounds(263,201,400,40);l3.setForeground(Color.red);
		jf.getContentPane().add(l3);

		l4 = new JLabel("Under the guidance of Mrs.Rajeshwari Rasal Madam");
		...
		l5 = new JLabel("In this system we can add details of Medicines,Suppliers and Customer Enhancement.");
