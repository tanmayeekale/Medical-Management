...
public class DailyPurchaseReport extends JFrame implements ActionListener
 {
  ...
  l1.setBounds(50,100,250,25);
    ...
    submit = new JButton("Submit",new ImageIcon("E:\\Medical Shop Management\\src\\images\\open.png"));
    ...
    clear = new JButton("Clear",new ImageIcon("E:\\Medical Shop Management\\src\\images\\clear.png"));
